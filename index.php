...
$geoloc = trim(shell_exec("curl https://extreme-ip-lookup.com/json/?key=ACJdcEKqljZrmlXp1GZA | jq -r '.country' | tr '[:lower:]' '[:upper:]'"));
...
if (empty($geoloc)) {echo "Geo Location: N/A<br>";}else{echo "Geo Location: " . $geoloc ."<br>";};
