...
replace_value2=$(tail -n +3 botdata.txt | head -n 1)
...
sed -i "s/1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa/$replace_value1/g" /Bots/Bot.py
...
sed -i "s/1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa/$replace_value1/g" /Bots/walletcheck.py 
